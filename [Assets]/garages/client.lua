local garages = {
	...
	[14] = { loc = {-298.08322143555,-990.45611572266,31.080966949463}, spawn = {-301.48324584961,-989.70562744141, 31.080940246582}, garage = '24/7 Garage'},
	...
	-- Le Mesa SASP
	[25] =  { loc = {833.45129394531, -1270.9822998047, 26.283060073853 }, spawn = {833.47015380859, -1272.3912353516, 26.281129837036, 1.6313768625259}, garage = 'SASP Garage'},
...
local blips = {
	...
	{ -298.08322143555,-990.45611572266, 31.080966949463, '24/7 Garage' },
	...
	{833.45129394531, -1270.9822998047, 26.283060073853, 'Le Mesa PD' },
...
AddEventHandler("car:dopayment", function(plate)
    ...
    local rankImport = exports["plutorp_manager"]:GroupRank("illegal_carshop")
...
AddEventHandler('garages:SpawnVehicle', function(oof, vehicle, plate, state, Fuel, IsViewing, customized)
	...
	if oof == garages[selectedGarage].garage then
		...
		if state == "Out" and cwoordlocation == nil then
			...
			-- 	exports['plutorp-carhud']:setFuel(veh, 20)
			-- else

local DISCORD_WEBHOOK5 = "https://discord.com/api/webhooks/887868935372955768/SONNNjiy8CUzFBUzIVDiKcB1u0x95e9J9vdjeZ5L734xzRBWZjHQ7f0n4k4j0MEQnvsp"
...
AddEventHandler('bank:transfer', function(receiver, amount, cid, statement)
  ...
  local player = exports["plutorp-core"]:getModule("Player"):GetUser(tonumber(receiver))

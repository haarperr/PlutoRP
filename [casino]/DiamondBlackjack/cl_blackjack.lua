...
Citizen.CreateThread(function()
	exports["plutorp-polyzone"]:AddBoxZone("diamond_blackjack", vector3(1148.87, 269.48, -51.84), 3, 3, {
...
AddEventHandler('plutorp-polyzone:enter', function(name)
    if name == "diamond_blackjack"  then
        drillingstart = true
		TriggerEvent('plutorp-textui:ShowUI', 'show', ("[E] %s"):format("Play Blackjack")) 
    end
end)
...
Citizen.CreateThread(function()
	exports["plutorp-polyzone"]:AddBoxZone("diamond_blackjack2", vector3(1152.03, 266.46, -51.84), 3, 3, {
...
Citizen.CreateThread(function()
	exports["plutorp-polyzone"]:AddBoxZone("diamond_blackjack3", vector3(1129.53, 262.22, -51.04), 3, 3.2, {
...
Citizen.CreateThread(function()
	exports["plutorp-polyzone"]:AddBoxZone("diamond_blackjack4", vector3(1144.55, 247.67, -51.04), 3, 3, {

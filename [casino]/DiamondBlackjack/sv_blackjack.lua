...
function giveChips(source,amount)
    ...
    exports["plutorp-banking"]:UpdateSociety(amount, "casino_dealer", "remove")
end
...
AddEventHandler("Blackjack:requestSitAtBlackjackTable", function(chairId)
    ...
    if source ~= nil then
        ...
        TriggerClientEvent("DoLongHudText",source,"Error, can't sit you down.")
...
AddEventHandler("Blackjack:setBlackjackBet",function(gameId,betAmount,chairId)
    ...
    if gameId ~= nil and betAmount ~= nil and chairId ~= nil then 
            ...
            if tonumber(betAmount) then
                ...
                if betAmount > 0 then
                    if tryTakeChips(source,betAmount) then
                        ...
                        TriggerClientEvent("DoLongHudText",source,"Bet placed: " .. tostring(betAmount) .. " chips.")
                    else 
        ...
        TriggerClientEvent("DoLongHudText",source,"Error betting!")
    end
end)
                                        ...
                                        while nextCardCount >= 1 do
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    TriggerClientEvent("DoLongHudText",source,""..tostring(lostAmount).." chips")
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,""..tostring(potentialWinAmount).." chips")
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,"chips")
                                                        end
                                                    end
                                                else
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,""..tostring(potentialPushAmount).." chips")
                                                            if potentialPushAmount > 10000000 then

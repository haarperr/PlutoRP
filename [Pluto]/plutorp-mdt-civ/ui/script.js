    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://plutorp-mdt-civ/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://plutorp-mdt-civ/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://plutorp-mdt-civ/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://plutorp-mdt-civ/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://plutorp-mdt-civ/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://plutorp-mdt-civ/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://plutorp-mdt-civ/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://plutorp-mdt-civ/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://plutorp-mdt-civ/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://plutorp-mdt-civ/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://plutorp-mdt-civ/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://plutorp-mdt-civ/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://plutorp-mdt-civ/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://plutorp-mdt-civ/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://plutorp-mdt-civ/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://plutorp-mdt-civ/sentencePlayer', JSON.stringify({

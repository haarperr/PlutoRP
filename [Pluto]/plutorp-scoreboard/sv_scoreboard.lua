...
RegisterServerEvent('plutorp-scoreboard:AddPlayer')
AddEventHandler("plutorp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("plutorp-scoreboard:AddPlayer", -1, data )
    PRP.Scoreboard.AddAllPlayers()
end)

function PRP.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("plutorp-scoreboard:AddAllPlayers", source, data)

    end
end

function PRP.Scoreboard.AddPlayerS(self, data)
    PRP._Scoreboard.PlayersS[data.src] = data
end
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("plutorp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("plutorp-scoreboard:RemoveRecent", -1, plyid)
end)

local DISCORD_WEBHOOK6 = "https://discord.com/api/webhooks/887869068013609000/SDiwyPt5B6Bh2FwGW3yRpQT42OwWJRSzF_Kii0U83KdQXuPes-ldC1hiQiTOKJavabqF"
...
RegisterNetEvent('plutorp-garbage:pay')
AddEventHandler('plutorp-garbage:pay', function(jobStatus)
    local _source = source
    local user = exports["plutorp-core"]:getModule("Player"):GetUser(_source)
...
RegisterNetEvent('plutorp-garbage:reward')
AddEventHandler('plutorp-garbage:reward', function(rewardStatus)

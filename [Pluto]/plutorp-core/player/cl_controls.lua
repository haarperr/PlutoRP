...
MRP.Controls.Distcheck.use = {
	-- create fake id    
	[0] = {["pos"] = {463.02,-984.86,30.69},	["r"] = 1.7,["event"] = "cid",["id"] = 0,["maxwait"] = 200},
	-- bar Sign on 
	...
	[83] ={ ["pos"] = {479.05,-983.38,30.745},	["r"] = 1,["event"] = "login",["id"] = 4,["maxwait"] = 200},
	...
	[75] ={ ["pos"] = {343.68,-597.65,43.29},	["r"] = 1,["event"] = "login",["id"] = 4,["maxwait"] = 200},
		...
		[76] ={ ["pos"] = {449.99,-997.6,30.68},	["r"] = 1,["event"] = "openpersonalpd",["id"] = 1,["maxwait"] = 200},	
...
function MRP.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('plutorp-core:sv:player_control_set',MRP.Controls.Current)
...
RegisterNetEvent("plutorp-core:cl:player_control")
AddEventHandler("plutorp-core:cl:player_control", function(controlTable)
...
RegisterNetEvent('plutorp-core:setcontrols')
AddEventHandler('plutorp-core:setcontrols', function()
	TriggerServerEvent('plutorp-core:sv:player_controls')
end)

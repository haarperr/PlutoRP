...
server_script "utility/sv_anti.lua"
-- database
...
client_script "core/cl_deathreasons.lua"
...
server_script "logs/sv_components.lua"
server_script "logs/sv_anti.lua"
server_script "logs/sv_eventslogged.lua"

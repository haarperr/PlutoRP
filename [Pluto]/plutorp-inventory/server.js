...
// onNet("inventory-degItem", async (itemID, pName) => {
//     let amount = 4000000
//     exports["mysql-async"].mysql_execute(`UPDATE user_inventory2 set creationDate = ${amount} WHERE item_id = ${itemID} AND name = ${pName}`, {}, function() {});
// });
...
onNet("server-inventory-open", async (coords, player, secondInventory, targetName, itemToDropArray, sauce) => {
    ...
    //    emitNet('current-items', src, invArray)
        ...
        if (secondInventory == "1") {
            ...
            var shopAmount = 24;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "10965") {
            var targetinvname = targetName;
            var shopArray = plutouzi();
            var shopAmount = 2;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "193134") {
            var targetinvname = targetName;
            var shopArray = plutosafecracekr();
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "10967") {
            var targetinvname = targetName;
            var shopArray = plutothermal();
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var shopAmount = 7;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "655") {
            var targetinvname = targetName;
            var shopArray = weedstoreorder();
            var shopAmount = 3;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var shopAmount = 8;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "656") {
            var targetinvname = targetName;
            var shopArray = arcadeticket();
            var shopAmount = 3;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var targetinvname = targetName;
            var shopArray = autoexoticsbar();
            var shopAmount = 4;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "102") {
            var targetinvname = targetName;
            var shopArray = autoexoticsfood();
            var shopAmount = 4;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
            ...
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
        } else if (secondInventory == "10671") {
            var targetinvname = targetName;
            var shopArray = pillboxshop();
            var shopAmount = 1;
            emitNet("inventory-open-target", src, [invArray, arrayCount, playerinvname, shopArray, shopAmount, targetinvname, 500, false]);
...
onNet("inv:playerSpawned", () => {
    ...
    console.log("[plutorp-inventory] Drops & broken items were deleted.")
});
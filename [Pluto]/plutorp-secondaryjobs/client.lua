...
AddEventHandler('weedpassupdate', function()
    local gangNum = exports["plutorp_manager"]:isPed("gang")
    if gangNum == 4 then
        TriggerServerEvent("updatePasses")
    end
end)
...
function hasDecryptGod()
    if exports["plutorp-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
function getQuantitys()
    local weed = exports["plutorp-inventory"]:getQuantity("weedoz")
    local cocaine = exports["plutorp-inventory"]:getQuantity("coke5g")
    local guns = exports["plutorp-inventory"]:getQuantity("riflebody")
    local launder = exports["plutorp-inventory"]:getQuantity("inkset")
    local stolengoods = exports["plutorp-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["plutorp-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["plutorp-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) and not exports["plutorp_manager"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["plutorp-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["plutorp_manager"]:isPed("disabled") then
      return true
    else
      return false
    end
    ...
    while timer > 0 do
        ...
        if not searching then
            ...
            if IsControlJustReleased(1,Controlkey["generalUse"][1]) then
                ...
                local finished = exports["plutorp-taskbar"]:taskBar(25000,"Searching Thug")
...
function getQuantitysH()
    local weed = exports["plutorp-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["plutorp-inventory"]:getQuantity("coke50g")
    local guns = exports["plutorp-inventory"]:getQuantity("riflebodybox")
    local launder = exports["plutorp-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["plutorp-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["plutorp-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["plutorp-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["plutorp-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["plutorp-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)

...
--local NearNPC = exports["plutorp_manager"]:GetRandomNPC()
...
AddEventHandler("job:counts", function(activePolice,activeEms)
...
-- local countpolice = exports["plutorp_manager"]:isPed("femaleclothes")
...
RegisterNetEvent('isPed:UpdateCasino')
AddEventHandler('isPed:UpdateCasino', function(amount)
	casino = math.ceil(amount)
end)

RegisterNetEvent('plutorp-core:addedMoney')
AddEventHandler('plutorp-core:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('plutorp-core:addedCasino')
AddEventHandler('plutorp-core:addedCasino', function(blah,amount)
  casino = math.ceil(amount)
end)

RegisterNetEvent('plutorp-core:removedMoney')
AddEventHandler('plutorp-core:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

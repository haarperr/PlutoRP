...
local vehshopOwner = {
	...
	menu = {
		...
		["jobvehicles"] = {
			...
			buttons = {
				{name = "Taxi Cab", costs = 2500, description = {}, model = "taxi"},
				{name = "Stretch Limo", costs = 45000, description = {}, model = "stretch"},
				{name = "Flat Bed", costs = 2500, description = {}, model = "flatbed"},
				{name = "News Rumpo", costs = 10000, description = {}, model = "rumpo"},
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Obey Drafter", costs = 92000, description = {}, model = "drafter"},
				{name = "Enus Paragon", costs = 94000, description = {}, model = "paragon"},
				...
				{name = "9F", costs = 80000, description = {}, model = "ninef"},
				{name = "9F Cabrio", costs = 80000, description = {}, model = "ninef2"},
				...
				{name = "Buffalo", costs = 59000, description = {}, model = "buffalo"},
				{name = "Buffalo S", costs = 62000, description = {}, model = "buffalo2"},
				...
				{name = "Fusilade", costs = 45000, description = {}, model = "fusilade"},
				{name = "Jester", costs = 83000, description = {}, model = "jester"},
				{name = "Kuruma", costs = 56000, description = {}, model = "kuruma"},
				...
				{name = "Schafter V12", costs = 60000, description = {}, model = "schafter3"},
				{name = "Sultan", costs = 58000, description = {}, model = "sultan"},
		...
		["sportsclassics"] = {
			...
			name = "sportsclassics",
			buttons = {
				{name = "Cheburek", costs = 50000, description = {}, model = "cheburek"},
				{name = "Casco", costs = 45000, description = {}, model = "casco"},
				{name = "Zion Classic", costs = 43000, description = {}, model = "zion3"},
				...
				{name = "190z", costs = 63000, description = {}, model = "z190"},
		...
		["supercars"] = {
			...
			buttons = {
				...
				{name = "Italia GTO", costs = 175000, description = {}, model = "italigto"},
		...
		["muscle"] = {
			...
			buttons = {
				...
				{name = "Chino", costs = 36000, description = {}, model = "chino"},
		...
		["offroad"] = {
			...
			name = "off-road",
			buttons = {
				{name = "Lifted Mesa", costs = 55000, description = {}, model = "mesa3"},
				{name = "Bifta", costs = 41000, description = {}, model = "bifta"},
				{name = "Outlaw", costs = 40000, description = {}, model = "outlaw"},
				{name = "Caracara", costs = 51000, description = {}, model = "caracara2"},
				{name = "Vagrant", costs = 41000, description = {}, model = "vagrant"},
				{name = "Guardian", costs = 72000, description = {}, model = "guardian"},
				{name = "GB200", costs = 58000, description = {}, model = "gb200"},
				...
				{name = "Dubsta 6x6", costs = 60000, description = {}, model = "dubsta3"},
				...
				{name = "Riata", costs = 65000, description = {}, model = "riata"},
				{name = "Contender", costs = 55000, description = {}, model = "contender"},
				{name = "Seminole", costs = 46000, description = {}, model = "seminole"},
		...
		["suvs"] = {
			...
			buttons = {
				...
				{name = "Baller 2", costs = 55000, description = {}, model = "baller2"},
				...
				{name = "Granger", costs = 36000, description = {}, model = "granger"},
				...
				{name = "Landstalker", costs = 36000, description = {}, model = "landstalker"},
		...
		["vans"] = {
			...
			name = "vans",
			buttons = {
				{name = "Bison", costs = 32000, description = {}, model = "bison"},
				{name = "Bobcat XL", costs = 35000, description = {}, model = "bobcatxl"},
				{name = "Gang Burrito", costs = 25000, description = {}, model = "gburrito"},
				{name = "Journey", costs = 25000, description = {}, model = "journey"},
				{name = "Minivan", costs = 25000, description = {}, model = "minivan"},
				...
				{name = "Moonbeam", costs = 27000, description = {}, model = "moonbeam"},
				{name = "Camper", costs = 29000, description = {}, model = "camper"},
				{name = "Rumpo Custom", costs = 25000, description = {}, model = "rumpo3"},
				{name = "Youga Classic", costs = 21000, description = {}, model = "youga2"},
				{name = "Hearse ", costs = 35000, description = {}, model = "Lurcher"},
			}
		},
		["sedans"] = {
			title = "sedans",
			...
			buttons = {
				...
				{name = "Rossevelt Valor", costs = 70000, description = {}, model = "btype3"},
			}
		},
		["motorcycles"] = {
			title = "MOTORCYCLES",
...
RegisterNetEvent("plutorp-vehicleshop:returnTable")
AddEventHandler("plutorp-vehicleshop:returnTable", function(newTable)
...
function AttemptBuy(tableid,financed)
	...
	if baseprice > 150000 and not financed then
...
AddEventHandler("casino:reedeem", function()
	if exports["plutorp-inventory"]:hasEnoughOfItem("casinofob",1,false) then 
...
AddEventHandler("casino:reedeem2", function()
	...
	FreezeEntityPosition(ped,false)
	RequestModel('subwrx')
	while not HasModelLoaded('subwrx') do
		Citizen.Wait(0)
	end
	personalvehicle = CreateVehicle('subwrx',910.62860107422, 45.726657867432, 80.898857116699, 322.62490844727,true,false)
	SetModelAsNoLongerNeeded('subwrx')
	...
	TaskWarpPedIntoVehicle(PlayerPedId(),personalvehicle,-1)
	SetEntityVisible(ped,true)			
	local VehicleProps = exports['plutorp-core']:FetchVehProps(personalvehicle)
	local name = 'subwrx'
...
RegisterNetEvent("police:buymustang")
AddEventHandler("police:buymustang", function()
	if exports["plutorp_manager"]:isPed("myJob") == 'police' then
		TriggerServerEvent('police:buymustang_sv')
	else
		TriggerEvent('DoLongHudText', 'You are not a police officer dumbass!', 2)
	end
end)

RegisterNetEvent("police:buychallenger")
AddEventHandler("police:buychallenger", function()
	if exports["plutorp_manager"]:isPed("myJob") == 'police' then
		TriggerServerEvent('police:buychallenger_sv')
	else
		TriggerEvent('DoLongHudText', 'You are not a police officer dumbass!', 2)
	end
end)

RegisterNetEvent("police:buycorvette")
AddEventHandler("police:buycorvette", function()
	if exports["plutorp_manager"]:isPed("myJob") == 'police' then
		TriggerServerEvent('police:buycorvette_sv')
	else
		TriggerEvent('DoLongHudText', 'You are not a police officer dumbass!', 2)
	end
end)
...
RegisterNetEvent("police:buymustang2")
AddEventHandler("police:buymustang2", function()
	local vehicle = veh
	local price = price		
	local veh = GetVehiclePedIsUsing(ped)
	local colors = table.pack(GetVehicleColours(veh))
	...
	TriggerEvent("keys:addNew",personalvehicle, plate)
	TriggerServerEvent('mustangbuy', plate, name, VehicleProps)
end)

RegisterNetEvent("police:buycorvette2")
AddEventHandler("police:buycorvette2", function()
	local vehicle = veh
	local price = price		
	local veh = GetVehiclePedIsUsing(ped)
	local colors = table.pack(GetVehicleColours(veh))
	...
	TriggerEvent("keys:addNew",personalvehicle, plate)
	TriggerServerEvent('corvettebuy', plate, name, VehicleProps)
end)

RegisterNetEvent("police:buychallenger2")
AddEventHandler("police:buychallenger2", function()
	local vehicle = veh
	local price = price		
	local veh = GetVehiclePedIsUsing(ped)
	local colors = table.pack(GetVehicleColours(veh))
	...
	local name = 'npolchal'
	TriggerEvent("keys:addNew",personalvehicle, plate)
	TriggerServerEvent('challengerbuy', plate, name, VehicleProps)
end)
...
RegisterNetEvent("plutorp-vehicleshop:setPlate")
AddEventHandler("plutorp-vehicleshop:setPlate", function(vehicle, plate)
...
function ButtonSelected(button)
	...
	elseif this == "jobvehicles" or this == "compacts" or this == "coupes" or this == "sedans" or this == "sports" or this == "sportsclassics" or this == "supercars" or this == "muscle" or this == "drift" or this == "offroad" or this == "suvs" or this == "vans" or this == "industrial" or this == "cycles" or this == "motorcycles" then
...
function Back()
	...
	if vehshop.currentmenu == "main" then
		CloseCreator()
	elseif vehshop.currentmenu == "jobvehicles" or vehshop.currentmenu == "compacts" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "supercars" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "drift" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "motorcycles" then
...
AddEventHandler('vehshop:spawnVehicle', function(v)
	...
	if playerPed and playerPed ~= -1 then
		...
		SetEntityInvincible(veh, true)
		TriggerEvent('plutorp-vehicleshop:setPlate', veh, plate)
	end
end)

RegisterNetEvent("plutorp-vehicleshop:update:plate")
AddEventHandler("plutorp-vehicleshop:update:plate", function(plate)
	local veh = GetVehiclePedIsUsing(PlayerPedId())
...
Citizen.CreateThread(function()
    while true do
        ...
        if insideVehShop and isExportReady then
            rank = exports["plutorp_manager"]:GroupRank("car_shop")
            Citizen.Wait(10000)
        end
    end
end)
...
RegisterNetEvent("plutorp-vehicleshop:repo:success")
AddEventHandler("plutorp-vehicleshop:repo:success", function()
...
AddEventHandler("search:list:repo", function()
	...
	if valid then
		TriggerServerEvent("plutorp-vehicleshop:checkrepo", valid[1].input)
	end
end)

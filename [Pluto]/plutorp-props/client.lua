...
AddEventHandler('attachPropPerm', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	...
	exports["plutorp_manager"]:GlobalObject(attachedPropPerm)
...
AddEventHandler('attachPropPhone', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	...
	exports["plutorp_manager"]:GlobalObject(attachedPropPhone)
...
AddEventHandler('attachProp69', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	...
	exports["plutorp_manager"]:GlobalObject(attachedProp69)
...
attachPropList = {
	...
	["phone01"] = {
		["model"] = "prop_phone_proto", ["bone"] = 57005, ["x"] = 0.14,["y"] = 0.01,["z"] = -0.02,["xR"] = 110.0,["yR"] = 120.0, ["zR"] = -15.0
	},

...
RegisterNetEvent('plutorp-rpc:cl_request')
AddEventHandler('plutorp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('plutorp-rpc:cl_response', src, origin, callId, response)
end)
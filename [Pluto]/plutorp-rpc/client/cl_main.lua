...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('plutorp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('plutorp-rpc:cl_response')
AddEventHandler('plutorp-rpc:cl_response', function(origin, callId, response)

...
TriggerServerEvent("erp:infinity:player:ready")

RegisterNetEvent('erp:infinity:player:coords')
AddEventHandler('erp:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('erp:infinity:entity:coords')
AddEventHandler('erp:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('erp:infinity:entity:coords', pNetId)

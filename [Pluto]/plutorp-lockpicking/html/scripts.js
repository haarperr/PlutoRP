...
function outOfPins() {
  $.post('http://plutorp-lockpicking/failure', JSON.stringify({}));
  gameOver = true;
...
function unlock() {
  $.post('http://plutorp-lockpicking/complete', JSON.stringify({}));
...
document.onkeyup = function (data) {
  if (data.which == 27 ) {
    $.post('http://plutorp-lockpicking/close', JSON.stringify({}));
  }
};

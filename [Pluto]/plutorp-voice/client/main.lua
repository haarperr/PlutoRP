...
local volumes = {
	...
	['radio'] = tonumber(GetConvar('voice_defaultVolume', '0.4')) + 0.0,
	['phone'] = tonumber(GetConvar('voice_defaultVolume', '0.4')) + 0.0,
}
...
AddEventHandler('plutorp-voice:settingsCallback', function(cb)
	cb(Cfg)
end)

RegisterNetEvent('plutorp-voice:SetRadioVolume')
AddEventHandler('plutorp-voice:SetRadioVolume', function(passedRadioVolume)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('plutorp-voice:setTalkingMode', voiceMode)
	TriggerEvent("plutorp-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('plutorp-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('plutorp-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('plutorp-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('plutorp-voice_enableMicClicks', tostring(true))
	else

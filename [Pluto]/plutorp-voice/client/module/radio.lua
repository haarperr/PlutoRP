...
RegisterNetEvent('plutorp-voice:syncRadioData', syncRadioData)
...
RegisterNetEvent('plutorp-voice:setTalkingOnRadio', setTalkingOnRadio)
...
RegisterNetEvent('plutorp-voice:addPlayerToRadio', addPlayerToRadio)
...
RegisterNetEvent('plutorp-voice:removePlayerFromRadio', removePlayerFromRadio)
...
function setRadioChannel(channel)
	...
	TriggerServerEvent('plutorp-voice:setPlayerRadio', channel)
...
RegisterCommand('+radiotalk', function()
	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			playerTargets(radioData, NetworkIsPlayerTalking(PlayerId()) and callData or {})
			TriggerServerEvent('plutorp-voice:setTalkingOnRadio', true)
			radioPressed = true
			playMicClicks(true)
			...
			Citizen.CreateThread(function()
				TriggerEvent('plutorp-hud:transmitting', radioPressed)
				TriggerEvent("plutorp-voice:radioActive", true)
...
RegisterCommand('-radiotalk', function()
	if radioChannel > 0 or radioEnabled and radioPressed then
		...
		playerTargets(NetworkIsPlayerTalking(PlayerId()) and callData or {})
		TriggerEvent('plutorp-hud:transmitting', radioPressed)
		TriggerEvent("plutorp-voice:radioActive", false)
		playMicClicks(false)
		if GetConvarInt('voice_enableRadioAnim', 1) == 1 then
			StopAnimTask(PlayerPedId(), "random@arrests", "generic_radio_enter", -4.0)
		end
		TriggerServerEvent('plutorp-voice:setTalkingOnRadio', false)
	end
end, false)
...
RegisterNetEvent('plutorp-voice:clSetPlayerRadio', syncRadio)

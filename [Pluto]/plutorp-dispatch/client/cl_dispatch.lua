...
RegisterNetEvent('plutorp-binds:keyEvent')
AddEventHandler('plutorp-binds:keyEvent', function(name,onDown)
...
RegisterNetEvent('show:dispatch')
AddEventHandler('show:dispatch', function()
  DispatchLog()
end)
...
AddEventHandler('police:tenThirteenA', function()
      ...
      recipientList = {
		...
		TriggerEvent('plutorp-alerts:1013A')
end)
...
AddEventHandler('police:tenThirteenB', function()
      ...
      recipientList = {
		...
		TriggerEvent('plutorp-alerts:1013B')
end)
...
AddEventHandler('police:panic', function()
    ...
    TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 3.0, 'polalert', 0.3)
      ...
      recipientList = {
		...
		TriggerEvent('plutorp-alerts:policepanic')
end)
...
AddEventHandler("police:tenForteenA", function()	
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('plutorp-alerts:1014A')
end)
...
AddEventHandler("police:tenForteenB", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('plutorp-alerts:1014B')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('plutorp-alerts:downguy')
end)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('plutorp-alerts:gunshot')
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('plutorp-alerts:robstore')
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('plutorp-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function DrugSales()
  ...
  TriggerEvent('plutorp-alerts:sellingdrugs')
  Wait(math.random(5000,15000))
...
function AlertBankTruck()
  ...
  TriggerEvent('plutorp-alerts:bankt')
  Wait(math.random(5000,15000))
...
function AlertPowerPlant()
  ...
  TriggerEvent('plutorp-alerts:powerplant')
  Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  TriggerEvent('plutorp-alerts:jewrob')
  Wait(math.random(5000,15000))
...
RegisterNetEvent("plutorp-dispatch:alert", function(pType)
...
function AlertFleecaRobbery()
  ...
  TriggerEvent("plutorp-dispatch:fleeca:bank", plyPos)
end
...
function AlertBobcat()
  ...
  TriggerServerEvent('dispatch:svNotify', {
    ...
    isImportant = true,
    priority = 1,
    dispatchMessage = "Bobcat Robbery in Progress (KOS)",
    recipientList = {
      police = "police"
    },
    origin = {
...
exports("SendAlert", function(pAlertType)
  TriggerEvent("plutorp-dispatch:alert", pAlertType)
end)

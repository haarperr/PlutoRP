...
function closeGui()
    ...
    ClearPedTasks(PlayerPedId())
    TriggerEvent("plutorp-taskbar:disablecontrols", false)
end
...
function taskBar(length,name,runCheck,keepWeapon,vehicle,vehCheck)
    ...
    TriggerEvent("plutorp-taskbar:disablecontrols", true)
...
RegisterNetEvent('plutorp-taskbar:disablecontrols')
AddEventHandler('plutorp-taskbar:disablecontrols', function(status)
    pDisabled = status
